...
describe("AuthService - Comprehensive Coverage", () => {
    ...
    beforeEach(() => {
        ...
        service = new authService_1.AuthService(mockRepo);
    });
    afterEach(() => {
    ...
    describe("Timeout Protection - Login", () => {
        ...
        it("login() should timeout and reject if state machine doesn't respond", async () => {
            ...
            jest.advanceTimersByTime(authConstants_1.AUTH_OPERATION_TIMEOUT_MS + 1000);
        ...
        it("login() timeout error message should include timeout value", async () => {
            ...
            jest.advanceTimersByTime(authConstants_1.AUTH_OPERATION_TIMEOUT_MS + 1000);
            await expect(loginPromise).rejects.toThrow(new RegExp(authConstants_1.AUTH_OPERATION_TIMEOUT_MS.toString()));
        });
    });
    ...
    describe("Timeout Protection - Session Check", () => {
        ...
        it("checkSession() should use longer timeout than other operations", async () => {
            expect(authConstants_1.SESSION_CHECK_TIMEOUT_MS).toBeGreaterThan(authConstants_1.AUTH_OPERATION_TIMEOUT_MS);
        });
    });
    ...
    describe("Timeout Constants Validation", () => {
        it("AUTH_OPERATION_TIMEOUT_MS should be 30 seconds", () => {
            expect(authConstants_1.AUTH_OPERATION_TIMEOUT_MS).toBe(30 * 1000);
        });
        it("SESSION_CHECK_TIMEOUT_MS should be 35 seconds", () => {
            expect(authConstants_1.SESSION_CHECK_TIMEOUT_MS).toBe(35 * 1000);
        });
