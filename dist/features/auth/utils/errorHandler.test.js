...
describe("errorHandler", () => {
    ...
    describe("handleApiError", () => {
        it("should throw server-provided error message", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            try {
                (0, errorHandler_1.handleApiError)(axiosError);
        ...
        it("should throw generic message when not an Axios error", () => {
            ...
            try {
                (0, errorHandler_1.handleApiError)(new Error("boom"));
                fail('Expected ApiError to be thrown');
            }
            catch (error) {
                expect(error).toBeInstanceOf(errorHandler_1.ApiError);
        ...
        it("should throw generic message for non-axios error", () => {
            mockedAxios.isAxiosError.mockReturnValue(false);
            try {
                (0, errorHandler_1.handleApiError)("some string error");
                fail('Expected ApiError to be thrown');
            }
            catch (error) {
                expect(error).toBeInstanceOf(errorHandler_1.ApiError);
        ...
        it("should handle 400 status with message", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Bad request");
        });
        it("should handle 401 status", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Unauthorized");
        });
        it("should handle 403 status", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Forbidden");
        });
        it("should handle 404 status", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Not found");
        });
        it("should handle 429 rate limit", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow(errorCodes_1.ErrorMessages[errorCodes_1.AuthErrorCode.TOO_MANY_REQUESTS]);
        });
        it("should handle 500 server error", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow(errorCodes_1.ErrorMessages[errorCodes_1.AuthErrorCode.SERVER_ERROR]);
        });
        ...
        it("should handle response without message", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Network error");
        });
        it("should handle missing response", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Connection timeout");
        });
        ...
        it("should handle unknown status with message", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("I'm a teapot");
        });
        ...
        it("should handle 504 with message field taking precedence over error field", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Custom gateway timeout");
        });
        it("should handle network error (no response)", () => {
            ...
            mockedAxios.isAxiosError.mockReturnValue(true);
            expect(() => (0, errorHandler_1.handleApiError)(axiosError)).toThrow("Network error occurred");
        });
    });
